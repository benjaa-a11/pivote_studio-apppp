              ...
              children: [
                ...
                _buildSection(context, 'Preferencias', [
                  ...
                  _buildSettingTile(
                    ...
                    onTap: () {
                      _open(const StorageManagerScreen()).then((_) => _loadCacheInfo());
                    },
                  ),
                ]),
                  ...
                  child: Column(
                    children: [
                          ...
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text('Cuenta activa', style: GoogleFonts.spaceGrotesk(fontSize: 10, fontWeight: FontWeight.w800)),
                              ],
                            ),
                          ),
                        ],
                        ...
                        children: [
                          Container(
                            ...
                            child: CircleAvatar(
                              ...
                              child: imagePath == null ? Icon(Icons.person_rounded, size: 54, color: theme.colorScheme.primary) : null,
                            ),
                          ),
                          Positioned(
                            right: 2,
                      ...
                      Text(
                        ...
                        style: GoogleFonts.spaceGrotesk(fontSize: 13, fontWeight: FontWeight.w600, color: theme.colorScheme.onSurface.withValues(alpha: .55)),
                      ),
                      ...
                      Text(
                        ...
                        maxLines: 1,
                        overflow: TextOverflow.ellipsis,
                        style: GoogleFonts.spaceGrotesk(fontSize: 11.5, fontWeight: FontWeight.w600, color: theme.colorScheme.onSurface.withValues(alpha: .52)),
                      ),
      ...
      child: Column(
        ...
        children: [
          Padding(
            ...
            child: Row(
              children: [
                Text(title, style: GoogleFonts.spaceGrotesk(fontSize: 13, fontWeight: FontWeight.w900)),
                const Spacer(),
          ...
          Material(
            ...
            child: Container(
              decoration: BoxDecoration(borderRadius: BorderRadius.circular(20), border: Border.all(color: theme.dividerColor.withValues(alpha: .07))),
              child: Column(
                children: [
    ...
    return Material(
      ...
      child: InkWell(
        ...
        child: Padding(
          ...
          child: Row(
            children: [
              Container(width: 42, height: 42, decoration: BoxDecoration(color: color.withValues(alpha: .1), borderRadius: BorderRadius.circular(13)), child: Icon(icon, size: 20, color: color)),
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        const SizedBox(width: 12),
                        Expanded(child: Text('Verificar actualizaciones', style: GoogleFonts.spaceGrotesk(fontSize: 13, fontWeight: FontWeight.w800))),
